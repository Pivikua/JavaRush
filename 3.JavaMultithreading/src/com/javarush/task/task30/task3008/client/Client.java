...
//
//    protected String getServerAddress() {
//        ConsoleHelper.writeMessage("Введите адресс сервера для начла работы");
//        return ConsoleHelper.readString();
//    }
//
//    protected int getServerPort() {
...
//
//    protected String getUserName() {
//        ConsoleHelper.writeMessage("Введите имя пльзователя");
//        return ConsoleHelper.readString();
//    }
//
//    protected boolean shouldSendTextFromConsole() {
...
//
//        protected void informAboutAddingNewUser(String userName) {
//            ConsoleHelper.writeMessage("Участник с именнем " + userName + " присоеденился к чату.");
//        }
//
//        protected void informAboutDeletingNewUser(String userName) {
//            ConsoleHelper.writeMessage("Участник с именнем " + userName + " покинул чат.");
//        }
//
//        protected void notifyConnectionStatusChanged(boolean clientConnected) {
//            synchronized (Client.this) {
...
//            } catch (IOException e) {
//                e.printStackTrace();
//                ConsoleHelper.writeMessage("Ошибка в главном цикле потока клиента!");
//                notifyConnectionStatusChanged(false);
//            } catch (ClassNotFoundException e) {
//                e.printStackTrace();
//                ConsoleHelper.writeMessage("Ошибка в главном цикле потока клиента!");
