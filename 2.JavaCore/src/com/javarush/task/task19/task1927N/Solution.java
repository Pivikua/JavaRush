package com.javarush.task.task19.task1927N;
...
5. Метод main(String[] args) класса Solution должен создавать
    поток PrintStream (используй PrintStream c параметром конструктора ByteArrayOutputStream).
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        String[] splitedString = new String[string.split("\\n").length];
