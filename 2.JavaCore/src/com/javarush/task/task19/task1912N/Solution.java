package com.javarush.task.task19.task1912N;
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        PrintStream newOutputStram = new PrintStream(byteArrayOutputStream);
        System.setOut(newOutputStram);
        testString.printSomething();
        System.setOut(savedStream);
        String outputString = byteArrayOutputStream.toString().replace("te", "??");
