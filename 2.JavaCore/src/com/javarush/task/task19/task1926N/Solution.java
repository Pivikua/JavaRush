package com.javarush.task.task19.task1926N;
...
public class Solution {
    public static void main(String[] args) throws IOException {
        ...
        String lineFromFile;
        while ((lineFromFile = fileLineReader.readLine()) != null ) System.out.println(new String(new StringBuilder().append(lineFromFile).reverse()));
    }
}
